...
Attacklab.wmdBase = function(){
	...
	// entering links.
    var imageDialogText = "<p style='margin-top: 0px'>" + $.i18n._('Deb Deine Bild URL ein') + "</p>";
    var linkDialogText = "<p style='margin-top: 0px'>" + $.i18n._('URL eingeben') + "</p>";
    var uploadImageHTML ="<div>" + $.i18n._('Bild hochladen') + "</div>" +
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			boldButton.title = "Stark <strong> Ctrl+B";
			...
			italicButton.title = "Emphatisch <em> Ctrl+I";
			...
			codeButton.title = "Code Beispiel <pre><code> Ctrl+K";
			...
			imageButton.title = "Bild <img> Ctrl+G";
			...
			olistButton.title = "Nummerierte Liste <ol> Ctrl+O";
			...
			ulistButton.title = "Aufzählungsliste <ul> Ctrl+U";
			...
			headingButton.title = "Überschrift <h1>/<h2> Ctrl+H";
			...
			hrButton.title = "Horizontaler Teiler <hr> Ctrl+R";
			...
			redoButton.title = "Wiederholen - Ctrl+Y";
	...
	command.doCode = function(chunk, postProcessing, useDefaultText){
		...
		if((!hasTextAfter && !hasTextBefore) || /\n/.test(chunk.selection)){
			...
			if(!chunk.selection){
				chunk.startTag = "    ";
				chunk.selection = useDefaultText ? "Code hier eingeben" : "";
			}
			else {
